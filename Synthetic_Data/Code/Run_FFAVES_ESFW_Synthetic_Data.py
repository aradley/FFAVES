...
# FFAVES
Track_Imputation_Steps, Track_Percentage_Imputation = ffaves.FFAVES(Discretised_Data)
# Calculate correlation matricies
Chosen_Cycle = -1
Sort_Gains, Sort_Weights, Cycle_Suggested_Imputations, ES_Matrices_Features_Used_Inds = ffaves.Calculate_ES_Sort_Matricies(Discretised_Data, Track_Imputation_Steps, Chosen_Cycle=Chosen_Cycle)
# ESFW
Feature_Divergences, Cycle_Suggested_Imputations, Feature_Divergences_Used_Inds = ffaves.ESFW(0.1, Discretised_Data, Track_Imputation_Steps, Chosen_Cycle=Chosen_Cycle)
# Feature weights
...
Optimal_Thresholds = ffaves.Parallel_Optimise_Discretisation_Thresholds(np.asarray(Drop_Out_Synthetic_Data).astype("f"),Discretised_Data.astype("f"),Cycle_Suggested_Imputations)
